...
**Date:** April 30, 2026
**Github Link:** https://github.com/ananya1806/ml-project
...
To ensure visual diversity and complexity, the dataset spans simple geometric primitives, single-path icons, and multi-path font glyphs. Below are randomly sampled and rendered SVGs straight from the training corpus to illustrate the structural variety the model was tasked with learning:

<table>
  <tr>
    <td align="center"><strong>Fonts</strong></td>
    <td align="center"><strong>Icons</strong></td>
    <td align="center"><strong>Emojis</strong></td>
  </tr>
  <tr>
    <td align="center"><img src="data/cleaned/svg-fonts-simple__000000.svg" width="150" /></td>
    <td align="center"><img src="data/cleaned/svg-icons-simple__000000.svg" width="150" /></td>
    <td align="center"><img src="data/cleaned/svg-emoji-simple__000000.svg" width="150" /></td>
  </tr>
  <tr>
    <td align="center"><img src="data/cleaned/svg-fonts-simple__000001.svg" width="150" /></td>
    <td align="center"><img src="data/cleaned/svg-icons-simple__000001.svg" width="150" /></td>
    <td align="center"><img src="data/cleaned/svg-emoji-simple__000001.svg" width="150" /></td>
  </tr>
</table>
---
...
*This section provides further examples of SVGs generated by the μP XL model under various sampling configurations, demonstrating the model's ability to extrapolate on structural motifs over longer sequences.*

![Additional Unconditional Generations](generated/appendix_unconditional_extra.png)
![Additional Prefix Completions](generated/appendix_prefix_extra.png)

### Appendix C: Extended Experimental Details
**Hardware and Environment:**
All models were trained on an NVIDIA A100-SXM4-80GB GPU. Environment setup included PyTorch 2.2 with CUDA 12.1. Flash Attention 2 was utilized to optimize the scaled dot-product attention computations, which was critical for maintaining throughput with a 1,024 context window.

**Data Repair Heuristics:**
For SVGs truncated at the maximum context length during generation, a custom post-processing script was applied. The script traverses the generated string backward:
1. It closes any unclosed quotes (`"`).
2. It identifies the last opened XML tag and generates its corresponding closing tag (e.g., `</path>`).
3. It appends the required root closure (`</svg>`) to ensure the file can be parsed and rendered by `cairosvg`.
